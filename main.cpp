...
std::cout<<"MYSTERY SORT 2"<<std::endl;
//print the trial number
//   std::cout << "Trial: " << j + 1 << std::endl;
...
std::cout << std::fixed << time_in_seconds.count() << std::endl;
std::cout <<std::endl<<std::endl;
std::cout<<"MYSTERY SORT 3"<<std::endl;
//print the trial number
//   std::cout << "Trial: " << j + 1 << std::endl;
...
std::cout <<std::endl<<std::endl;
std::cout<<"MYSTERY SORT 4"<<std::endl;
//print the trial number
//   std::cout << "Trial: " << j + 1 << std::endl;
...
std::cout <<std::endl<<std::endl;
std::cout<<"MYSTERY SORT 5"<<std::endl;
//print the trial number
//   std::cout << "Trial: " << j + 1 << std::endl;
